    ...
    public partial class Home : Form
    {
        ...
        private void home_login_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                MySqlCommand select = new MySqlCommand("Select * FROM hrm_database.goverment_users where name = '" + home_txtUsername.Text + "' and password = '" + md5pass + "';" ,Utils.MySql.myConn);
